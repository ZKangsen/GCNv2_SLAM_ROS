...
#GCN_PATH=gcn2_320x240.pt ./rgbd_gcn ../Vocabulary/GCNvoc.bin TUM3_small.yaml /home/mogo/zkn/openslam/datasets/rgbd_dataset_freiburg1_xyz /home/mogo/zkn/openslam/datasets/rgbd_dataset_freiburg1_xyz/associations.txt

# 640x480 resolution example
FULL_RESOLUTION=1 GCN_PATH=gcn2_640x480.pt ./rgbd_gcn ../Vocabulary/GCNvoc.bin TUM3.yaml /data/autocar/zhangkangning/openslam/datasets/rgbd_dataset_freiburg1_xyz /data/autocar/zhangkangning/openslam/datasets/rgbd_dataset_freiburg1_xyz/associations.txt
